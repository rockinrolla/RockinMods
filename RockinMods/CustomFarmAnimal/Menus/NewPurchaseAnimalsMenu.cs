...
{
    class NewPurchaseAnimalsMenu : IClickableMenu
    {
        public static CustomBarnDwellerData Data;
        ...
        private CustomFarmAnimal animalBeingPurchased;
        ...
        public void textBoxEnter(TextBox sender)
        {
            ...
            if(Game1.activeClickableMenu == null || !(Game1.activeClickableMenu is NewPurchaseAnimalsMenu))
            {
            ...
            {
                if(StardewValley.Utility.areThereAnyOtherAnimalsWithThisName(sender.Text))
                {
                ...
                (this.newAnimalHome.indoors as NewAnimalHouse).animals.Add(this.animalBeingPurchased.myId, this.animalBeingPurchased);
        ...
        public override void draw(SpriteBatch b)
        {
            ...
            if(!Game1.globalFade && this.onFarm)
            {
                ...
                {
                    this.animalBeingPurchased.home,
                    this.animalBeingPurchased.type
                });
            ...
            if(this.hovered != null)
            {
                ...
                {
                    string animalTitle = NewPurchaseAnimalsMenu.getAnimalTitle(this.hovered.hoverText);
                    ...
                    string animalDescription = NewPurchaseAnimalsMenu.getAnimalDescription(this.hovered.hoverText);
